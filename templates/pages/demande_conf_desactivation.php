...
// Template : Affiche un message demandant de confirmer la desactivation d'un compte membre
// Paramètres : $membre qui ets soit un objet gestionnaire soit un objet investisseur
...
<head>
    ...
    <title>Desactiver le membre</title>
</head>
<body>
    <?php include_once "templates/fragments/header.php"; ?>

    <main>
        <h1 class="mt32 ml64 mb64">Voulez vous désactiver le compte de ce membre?</h1>
        <div class="cont1200 flexwrap flexcolumn align-center g32">
            ...
            <div class="flexwrap justcenter g16 align-center">
                <a href="desactiver_membre.php?id=<?=$membre->id()?>&typeCompte=<?=$_GET["typeCompte"]?>" class="desbtn">Desactiver</a>
