...
<body>
    ...
    <main>
    <h2 class="mt32 mb64 textcenter">Connexion en tant qu'investisseur</h2>
        <form action="connecter_utilisateur.php?typeCompte=investisseur" method="post" class="flexwrap flexcolumn align-center cont1200 g64 aos-item" data-aos="fade-left" data-aos-duration="1500">
